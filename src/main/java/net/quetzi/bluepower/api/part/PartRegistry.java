...
public class PartRegistry {
     ...
     * Register a part
     *
     * @param id   Part identifier (same as the one returned by the part)
     ...
     * @param isMultipart Whether it's using a multipart id or not (this is usually false)
     ...
     *
     * @param is The item to get the part id from
     * @return A new instance of the part or null if it couldn't be found
     */
