...
public class Config {
    public static void setUp(Configuration config) {
        ...
        veinCountMalachite = config.get("World Gen", "veinCountMalachite", 2).getInt();
        veinSizeMalachite = config.get("World Gen", "veinSizeMalachite", 7).getInt();
    ...
    public static int veinCountMalachite;
    public static int veinSizeMalachite;
