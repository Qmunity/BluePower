...
import net.quetzi.bluepower.blocks.BlockMalachiteOre;
...
import net.quetzi.bluepower.blocks.BlockRubyOre;
import net.quetzi.bluepower.blocks.BlockSapphireBlock;
import net.quetzi.bluepower.blocks.BlockSapphireOre;
...
public class Blocks {
    ...
    private static void registerBlocks() {
        ...
        GameRegistry.registerBlock(new BlockRubyOre().setBlockName(Refs.RUBYORE_NAME), Refs.RUBYORE_NAME);
        GameRegistry.registerBlock(new BlockSapphireOre().setBlockName(Refs.SAPPHIREORE_NAME), Refs.SAPPHIREORE_NAME);
        GameRegistry.registerBlock(new BlockMalachiteOre().setBlockName(Refs.MALACHITEORE_NAME), Refs.MALACHITEORE_NAME);
