...
public class BPBlocks {
    ...
    private static void registerBlocks() {
        ...
        GameRegistry.registerBlock(basaltbrick_cracked,
                Refs.CRACKEDBASALTBRICK_NAME);
        GameRegistry.registerBlock(fancy_basalt, Refs.CHISELEDBASALTBRICK_NAME);
        GameRegistry.registerBlock(basalt_brick_small,
                Refs.SMALLBASALTBRICK_NAME);
        ...
        GameRegistry.registerBlock(marble_brick_small,
                Refs.SMALLMARBLEBRICK_NAME);
