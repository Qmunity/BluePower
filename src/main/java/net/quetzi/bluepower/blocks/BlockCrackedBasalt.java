...
public class BlockCrackedBasalt extends BlockStoneOre {
    ...
    /*
     * Debug, when testing, also change the 'random.nextInt(100)' to 'random.nextInt(1)' public boolean onBlockActivated(World world, int x, int y,
     * int z, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) { updateTick(world, x,y,z,new
     * Random()); return true; }
     */
