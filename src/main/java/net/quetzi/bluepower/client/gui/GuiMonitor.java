...
public class GuiMonitor extends GuiBase {
	 ...
	 */
	 public void drawTexturedModalRect2(int x, int z, int u, int v, int w, int h)
	 {
	        ...
	        tessellator.addVertexWithUV((double)(x + 0), (double)(z + h), (double)this.zLevel, (double)((float)(u + 0) * f), (double)((float)(v + h) * f1));
	        tessellator.addVertexWithUV((double)(x + w), (double)(z + h), (double)this.zLevel, (double)((float)(u + w) * f), (double)((float)(v + h) * f1));
	        tessellator.addVertexWithUV((double)(x + w), (double)(z + 0), (double)this.zLevel, (double)((float)(u + w) * f), (double)((float)(v + 0) * f1));
	        tessellator.addVertexWithUV((double)(x + 0), (double)(z + 0), (double)this.zLevel, (double)((float)(u + 0) * f), (double)((float)(v + 0) * f1));
	        tessellator.draw();
	 }
