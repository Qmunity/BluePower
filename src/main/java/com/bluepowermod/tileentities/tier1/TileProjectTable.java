...
public class TileProjectTable extends TileBase implements IInventory {
    ...
    public InventoryCrafting getCraftingGrid(Container listener) {
        ...
        try {
            stackListFieldInventoryCrafting.set(inventoryCrafting, craftingGrid);//Inject the array, so when stacks are being set to null by the container it'll make it's way over to the actual stacks.
