...
public class BPConfig {
    ...
    public static final BPConfig CONFIG = new BPConfig(BUILDER);
    ...
    public final ForgeConfigSpec.ConfigValue<Integer> vorpalEnchantmentId;
    public final ForgeConfigSpec.ConfigValue<Integer> disjunctionEnchantmentId;
    ...
    BPConfig(ForgeConfigSpec.Builder builder) {
        ...
        alloyFurnaceBlacklist = builder.comment( "Any item name ('minecraft:bucket', 'minecraft:minecart') added here will be blacklisted from being able to melt down into its raw materials.").translation("bluepower.config.alloy_furnace.blacklist").define("alloyFurnaceBlacklist", new String[0]);
        ...
        builder.push(Refs.CONFIG_ENCHANTS).comment("Enchantment IDs");
        vorpalEnchantmentId = builder.comment("Vorpal Enchantment ID").translation("bluepower.config.vorpal.id").define("vorpalEnchantmentId", findFreeEnchantID());
        disjunctionEnchantmentId = builder.comment("Disjunction Enchantment ID").translation("bluepower.config.disjunction.id").define("disjunctionEnchantmentId", findFreeEnchantID(vorpalEnchantmentId.get()));
    ...
    private static int findFreeEnchantID(int... ignored) {
        ...
        for (int i = 20; i < ForgeRegistries.ENCHANTMENTS.getKeys().toArray().length; i++) {
            ...
            if (!ignore && ForgeRegistries.ENCHANTMENTS.getKeys().toArray()[i] == null)
                return i;
        }
        return 0;
    }
