...
public class BPItems {
    ...
    public static IItemTier gemItemTier = new BPItemTier(750, 6, 2.0F, 4, 18, Ingredient.fromItems(BPItems.amethyst_gem, BPItems.ruby_gem, BPItems.sapphire_gem, BPItems.green_sapphire_gem));
    ...
    public static final Item green_sapphire_saw = new ItemSaw(gemItemTier.getHarvestLevel(), Refs.GREENSAPPHIRESAW_NAME);
