...
public class BPItems {
    ...
    public static final Item wood_sickle = new ItemSickle(ItemTier.WOOD, Refs.WOODSICKLE_NAME, Item.byBlock(Blocks.OAK_PLANKS));
    public static final Item stone_sickle = new ItemSickle(ItemTier.STONE, Refs.STONESICKLE_NAME, Item.byBlock(Blocks.COBBLESTONE));
    ...
    public static final Item iron_saw = new ItemSaw(ItemTier.IRON.getLevel(), Refs.IRONSAW_NAME);
    public static final Item diamond_saw = new ItemSaw(ItemTier.DIAMOND.getLevel(), Refs.DIAMONDSAW_NAME);
    ...
    public static IItemTier gemItemTier = new BPItemTier(750, 6, 2.0F, 4, 18, Ingredient.of(BPItems.amethyst_gem, BPItems.ruby_gem, BPItems.sapphire_gem, BPItems.green_sapphire_gem));
