...
//    public static final Item plate_assembly = new ItemCrafting(Refs.PLATEASSEMBLY_NAME);
    ...
    public static final Item ruby_shovel = new ItemGemSpade(BluePower.gemMaterial, Refs.RUBYSPADE_NAME);
    ...
    public static final Item sapphire_shovel = new ItemGemSpade(BluePower.gemMaterial, Refs.SAPPHIRESPADE_NAME);
    ...
    public static final Item amethyst_shovel = new ItemGemSpade(BluePower.gemMaterial, Refs.AMETHYSTSPADE_NAME);
