...
public class BPItems {
    ...
    public static final DeferredHolder<Item, Item> iron_saw = ITEMS.register(Refs.IRONSAW_NAME, () -> new ItemSaw(Tiers.IRON.getLevel()));
    public static final DeferredHolder<Item, Item> diamond_saw = ITEMS.register(Refs.DIAMONDSAW_NAME, () -> new ItemSaw(Tiers.DIAMOND.getLevel()));
    ...
    public static final DeferredHolder<Item, Item> ruby_saw = ITEMS.register(Refs.RUBYSAW_NAME,() ->  new ItemSaw(gemItemTier.getLevel()));
    ...
    public static final DeferredHolder<Item, Item> sapphire_saw = ITEMS.register(Refs.SAPPHIRESAW_NAME,() ->  new ItemSaw(gemItemTier.getLevel()));
    ...
    public static final DeferredHolder<Item, Item> green_sapphire_saw = ITEMS.register(Refs.GREENSAPPHIRESAW_NAME,() ->  new ItemSaw(gemItemTier.getLevel()));
    ...
    public static final DeferredHolder<Item, Item> amethyst_saw = ITEMS.register(Refs.AMETHYSTSAW_NAME,() ->  new ItemSaw(gemItemTier.getLevel()));
    ...
    public static final DeferredHolder<Item, Item> tungcarb_saw = ITEMS.register(Refs.TUNGCARBSAW_NAME,() ->  new ItemSaw(gemItemTier.getLevel()));
