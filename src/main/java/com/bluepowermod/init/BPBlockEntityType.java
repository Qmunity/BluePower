...
public class BPBlockEntityType {
    ...
    public static RegistryObject<BlockEntityType<TileRandomizer>> RANDOMIZER = BLOCK_ENTITY_TYPE.register("randomizer", () -> BlockEntityType.Builder.of(TileRandomizer::new, BPBlocks.blockRandomizer.get()).build(null));
