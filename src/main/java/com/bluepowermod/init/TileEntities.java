    ...
    public static class Registration {
        ...
        public static void onTileEntityTypeRegistry(final RegistryEvent.Register<TileEntityType<?>> event) {
            event.getRegistry().registerAll(
                    ...
                    TileEntityType.Builder.create(TileTube::new, BPBlocks.tube).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "tube")),
                    ...
                    TileEntityType.Builder.create(TileBlulectricCable::new, BPBlocks.blulectric_cable).build(null).setRegistryName(new ResourceLocation(Refs.MODID, Refs.BLULECTRICCABLE_NAME)),
                    TileEntityType.Builder.create(TileBlulectricFurnace::new, BPBlocks.blulectric_furnace).build(null).setRegistryName(new ResourceLocation(Refs.MODID, Refs.BLULECTRICFURNACE_NAME)),
                    TileEntityType.Builder.create(TileBlulectricAlloyFurnace::new, BPBlocks.blulectric_alloyfurnace).build(null).setRegistryName(new ResourceLocation(Refs.MODID, Refs.BLULECTRICALLOYFURNACE_NAME)),
                    TileEntityType.Builder.create(TileThermopile::new, BPBlocks.thermopile).build(null).setRegistryName(new ResourceLocation(Refs.MODID, Refs.THERMOPILE_NAME)),
                    ...
                    TileEntityType.Builder.create(TileProjectTable::new, BPBlocks.project_table).build(null).setRegistryName(ContainerNames.PROJECT_TABLE),
                    TileEntityType.Builder.create(TileAutoProjectTable::new, BPBlocks.auto_project_table).build(null).setRegistryName(ContainerNames.AUTO_PROJECT_TABLE),
                    ...
                    TileEntityType.Builder.create(TileWire::new, BPBlocks.blockRedAlloyWire, BPBlocks.blockBlueAlloyWire).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "wire")),
                    //TileEntityType.Builder.create(TileInsulatedWire::new, BPBlocks.blockInsulatedBlueAlloyWire, BPBlocks.blockInsulatedRedAlloyWire).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "insulatedwire")),
