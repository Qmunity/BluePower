    ...
    public static class Registration {
        ...
        public static void onTileEntityTypeRegistry(final RegistryEvent.Register<TileEntityType<?>> event) {
            event.getRegistry().registerAll(
                    ...
                    TileEntityType.Builder.create(TileBlockBreaker::new, BPBlocks.block_breaker).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "blockBreaker")),
                    ...
                    TileEntityType.Builder.create(TileSolarPanel::new, BPBlocks.solarpanel).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "solarpanel")),
                    ...
                    TileEntityType.Builder.create(TileAutoProjectTable::new, BPBlocks.auto_project_table).build(null).setRegistryName(new ResourceLocation(Refs.MODID, "autoProjectTable")),
