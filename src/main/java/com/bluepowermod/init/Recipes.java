...
public class Recipes {
    ...
    public static void init(CraftingManager craftManager) {
        ...
        af.addRecipe(new FluidStack(BPFluids.molten_brass, BPFluids.INGOT_AMOUNT * 4), new ItemStack(BPItems.copper_ingot, 3), BPItems.zinc_ingot);
        af.addRecipe(new FluidStack(BPFluids.molten_blue_alloy, BPFluids.INGOT_AMOUNT * 1), new ItemStack(BPItems.teslatite, 4), BPItems.silver_ingot);
        af.addRecipe(new FluidStack(BPFluids.molten_silicon, BPFluids.INGOT_AMOUNT * 1), new ItemStack(Items.coal, 8), new ItemStack(Blocks.sand, 8));
        ...
        // FIXME af.addRecyclingRecipe(new ItemStack(Blocks.gold_block));
        // FIXME af.addRecyclingRecipe(new ItemStack(Items.iron_ingot));
        // FIXME af.addRecyclingRecipe(new ItemStack(Items.gold_ingot));
        // FIXME af.addRecyclingRecipe(new ItemStack(Items.gold_nugget));
    }
