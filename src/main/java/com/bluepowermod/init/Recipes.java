...
public class Recipes {
    ...
    public static void init(CraftingManager craftManager) {
        ...
        //        craftManager.addRecipe(PartRegistry.getInstance().getItemForPart("bustransceiver"), "BBB", "N#N", "BBB", '#', BPItems.stone_tile, 'B', BPItems.stone_bundle, 'N', BPItems.red_doped_wafer);
        ...
        //        craftManager.addRecipe(PartRegistry.getInstance().getItemForPart("invert"), "#R#", "ROR", "#R#", '#', BPItems.stone_tile, 'O', BPItems.plate_assembly, 'R', BPItems.stone_redwire);
        ...
        //        craftManager.addRecipe(PartRegistry.getInstance().getItemForPart("noninvert"), "#R#", "ROR", "#RC", '#', BPItems.stone_tile, 'C', BPItems.stone_cathode, 'O', BPItems.plate_assembly, 'R', BPItems.stone_redwire);
        ...
        //        craftManager.addRecipe(PartRegistry.getInstance().getItemForPart("null"), "#R#", "RRR", "#R#", '#', BPItems.stone_tile, 'R', BPItems.stone_redwire);
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(PartRegistry.getInstance().getItemForPart("accelerator", 1), "OIO", "I I", "OIO", 'O', Blocks.obsidian, 'I', BPItems.blue_alloy_ingot));
        GameRegistry.addRecipe(new ShapedOreRecipe(PartRegistry.getInstance().getItemForPart("accelerator", 1), "IOI", "O O", "IOI", 'O', Blocks.obsidian, 'I', BPItems.blue_alloy_ingot));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BPBlocks.sorting_machine, 1), "CCC", "GPG", "CWC", 'C', "ingotIron", 'G', BPItems.red_doped_wafer, 'P', BPBlocks.filter, 'W', BPItems.blue_alloy_ingot));
        ...
        if (Loader.isModLoaded("ForgeMicroblock")) {
            ...
            ItemStack diamondSawFMP = new ItemStack(GameData.getItemRegistry().getObject("ForgeMicroblock:sawDiamond"));
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(BPItems.silicon_wafer, 16), new ItemStack(BPItems.diamond_saw), new ItemStack(BPItems.silicon_boule));
        }
