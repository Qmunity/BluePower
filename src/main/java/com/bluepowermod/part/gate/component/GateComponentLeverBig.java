...
public class GateComponentLeverBig extends GateComponentLever {

    public GateComponentLeverBig(GateBase gate, int color) {

        super(gate, color);
    }

    public GateComponentLeverBig(GateBase gate, double x, double z) {
    ...
    public void renderStatic(Vec3i translation, RenderHelper renderer, int pass) {
        ...
        renderer.renderBox(new Vec3dCube(0, 2 / 16D, 0, 6 / 16D, 5 / 16D, 8 / 16D), Blocks.cobblestone.getIcon(0, 0));
