...
public class GateAnd extends GateSimple<GateConnectionDigital> {
    ...
    public void initConnections() {
        ...
        front(new GateConnectionDigital(this, Dir.FRONT)).enable().setOutputOnly();
        right(new GateConnectionDigital(this, Dir.RIGHT)).enable();
        back(new GateConnectionDigital(this, Dir.BACK)).enable();
        left(new GateConnectionDigital(this, Dir.LEFT)).enable();
    }
    ...
    public void initComponents() {
        ...
        addComponent(t2 = new GateComponentTorch(this, 0x0000FF, 4 / 16D, true).setState(false));
        ...
        addComponent(wire = new GateComponentWire(this, 0x18FF00, RedwireType.BLUESTONE));
