...
public class Refs {
    ...
    private static final String MCVERSION = "1.21.8";
    ...
    public static final String TUBE_NAME = "pneumatic_tube";
    ...
    public static final String MULTIPART_NAME = "multipart";
    ...
    public static final VoxelShape CAGELAMP_AABB = Block.box(5, 2, 5,  11, 11, 11);
    public static final VoxelShape GATE_AABB = Block.box(0, 0, 0,  16, 2, 16);
    public static final String FIXTURELAMP_NAME = "fixture";
    public static final VoxelShape FIXTURELAMP_AABB = Block.box(3, 2, 3, 13, 8, 13);
